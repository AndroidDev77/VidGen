.PHONY: install lint format typecheck test schemas verify infra-up infra-down infra-logs observability-up observability-logs migrate migrate-down verify-stack run-worker run-api run-web web-install web-lint web-typecheck web-test web-build web-e2e verify-web local-reset
