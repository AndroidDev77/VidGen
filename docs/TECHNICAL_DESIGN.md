...
| T16 | In review | Deterministic per-shot Temporal children coordinate restartable T14 keyframe and T15 animation work with bounded ten-shot fan-out, isolated failure/cancellation, compact queries and commands, durable checkpoints, and T23-aware idempotency. Mark complete only after review and CI succeed. |
