...
| T17 | In review | T17 implements strict caption/render contracts, deterministic caption reflow, canonical manifests and identities, bounded FFmpeg argument plans, media verification, immutable asset provenance, and restartable relational projections. Mark complete only after review and CI succeed. |
