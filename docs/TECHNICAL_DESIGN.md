...
| T15 | In review | The Runway image-to-video branch adds authoritative T13/T14 selection, deterministic motion prompts and routing, durable asynchronous task checkpoints, bounded download, FFprobe validation, deterministic trimming, immutable AssetService provenance, T23 accounting, fake-provider execution, contracts, persistence, CLI, and parent-workflow integration. Do not mark complete until review and CI succeed. |
