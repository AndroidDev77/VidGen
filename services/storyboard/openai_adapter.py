...
SYSTEM_PROMPT = (
    ...
    "deliberate continuity change must carry an explaining warning. present_character_ids is "
    "the authoritative cast of a continuity state: every character you give a subject_position "
    "or a character_appearance_state must also appear in that state's present_character_ids.\n"
