...
export type FailureClass = "TRANSPORT" | "TIMEOUT" | "RATE_LIMIT" | "AUTHENTICATION" | "AUTHORIZATION" | "INVALID_REQUEST" | "PROVIDER_REJECTED" | "CONTENT_FILTER" | "CONTRACT_VALIDATION" | "QUALITY_FAILURE" | "BUDGET_EXCEEDED" | "CANCELLED" | "DATABASE" | "STORAGE" | "TEMPORAL" | "INTERNAL" | "UNKNOWN";
...
export interface FailureClassification { readonly schema_version: "1.0"; readonly failure_class: FailureClass; readonly error_code: string; readonly retryable: boolean; readonly sanitized_message: string; readonly diagnostic_metadata: Readonly<Record<string, unknown>>; }
