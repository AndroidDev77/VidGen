...
export interface ShotWorkflowInput { schema_version: "1.0"; project_id: UUID; storyboard_run_id: UUID; storyboard_shot_id: UUID; shot_input_hash: string; workflow_identity: ShotWorkflowIdentity; t14_run_id: UUID | null; t15_run_id: UUID | null; idempotency_key: string; trace_context: Record<string, string>; attempt_policy_version: "shot-attempt/1" }
